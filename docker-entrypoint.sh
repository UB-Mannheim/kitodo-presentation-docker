...
mysql -h db -D ${DB_NAME} -e "INSERT INTO tt_content (pid, cruser_id, CType, header, bodytext) VALUES ('1', '1', 'text', 'DFG-Viewer Examplebody', '<p>Nachfolgend befinden sich zwei Beispieldokumente zum Testen der OCR-On-Demand Funktionalität. Alternativ kann man die URL zu einer beliebigen METS-Datei in das Suchfeld einfügen. </p> <ul><li><a href=\"/index.php?id=2&amp;tx_dlf[id]=https%3A%2F%2Fdigi.bib.uni-mannheim.de%2Ffileadmin%2Fvl%2Fubmaosi%2F59087%2F59087.xml\">&Uuml;ber die Gesetze des geordneten Denkverlaufs [1913]</a></li><li><a href=\"/index.php?id=2&amp;tx_dlf[id]=https%3A%2F%2Fdigi.bib.uni-mannheim.de%2Ffileadmin%2Fvl%2Fubmaosi%2F59088%2F59088.xml\">Zur Psychologie des produktiven Denkens und des Irrtums [1922]</a></li></ul>');"
