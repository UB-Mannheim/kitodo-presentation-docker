...
if [ ! -f /initFinished ]; then
    ...
    jq '  .repositories += [
        ...
        | .require += {"ub-mannheim/dfgviewer": "dev-6.x-ocr#fc6142b3579a30706bd643ed456f4f91cc6f032d"}
    ...
    printHeadline "Setup Kitodo.Presentation: Update DB: Insert sites and properties:"
